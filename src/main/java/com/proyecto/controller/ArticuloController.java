...
public class ArticuloController {
    ...
    @GetMapping("/listadoMonedero")
    public String Monederos(Model model){  
        var articulos=articuloService.getArticulosCategorias(false,"Monedero");
        model.addAttribute("articulos",articulos);
        model.addAttribute("totalArticulos", articulos.size());
        return "/articulo/listadoMonedero";
    }
